...
##- Demo input values 
ref_row = 1200 # metadata row id 
text_subject = "metadata_en_processed"  
...
df = df[['features_properties_id', 'features_properties_title_en','metadata_en_processed']]
...
print("Model traning is based on title, describtion and keywords. \n")
